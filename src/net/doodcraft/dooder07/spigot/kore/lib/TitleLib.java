...
public class TitleLib {
     ...
     */
    public TitleLib(String title, String subtitle) {
        this.title = title;
     ...
     */
    public TitleLib(String title, String subtitle, int fadeInTime, int stayTime, int fadeOutTime) {
        this.title = title;
        this.subtitle = subtitle;
     ...
     * @param title Title
     */
    public TitleLib(TitleLib title) {
        // Copy title
